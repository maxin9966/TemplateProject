...
- (BOOL) isSameDayAsDate:(NSDate*)date
{
    ...
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"yyyy-MM-dd"];
    NSString *key_1 = [dateFormatter stringFromDate:self];
    NSString *key_2 = [dateFormatter stringFromDate:date];
    return [key_1 isEqualToString:key_2];
}
...
- (NSDate *) dateByAddingDays:(NSInteger)dDays hours:(NSInteger)dHours minutes:(NSInteger)dMinutes seconds:(NSInteger)dSecounds
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + D_DAY * dDays + D_HOUR*dHours + D_MINUTE*dMinutes + dSecounds;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}

- (NSDate *) dateByAddingSecounds: (NSInteger) dSecounds
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + dSecounds;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (NSDate *) dateAtStartOfDay
{
	...
	components.minute = 0;
	components.second = 0;
    NSTimeInterval ts = (double)(int)[[CURRENT_CALENDAR dateFromComponents:components] timeIntervalSince1970];
