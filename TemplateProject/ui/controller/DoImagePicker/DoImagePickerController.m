...
#define PhotoMarginX 10
#define PhotoMarginY 10
...
- (void)viewDidLoad
{
    ...
    self.navigationView.backgroundColor = DO_MENU_BACK_COLOR;
    ...
    layout.minimumInteritemSpacing = PhotoMarginX;
    layout.minimumLineSpacing = PhotoMarginY;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGFloat cellWidth = (width-(_nColumnCount+1)*PhotoMarginX)/_nColumnCount;
    return CGSizeMake(cellWidth, cellWidth);
}

- (UIEdgeInsets)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout insetForSectionAtIndex:(NSInteger)section
{
    return UIEdgeInsetsMake(PhotoMarginY, PhotoMarginX, PhotoMarginY, PhotoMarginX);
}
...
- (void)showPhotosInGroup:(NSInteger)nIndex
{
    ...
    [ASSETHELPER getPhotoListOfGroupByIndex:nIndex result:^(NSArray *aPhotos) {
		...
		if (aPhotos.count > 0)
		{
            ...
            [_cvPhotoList scrollToTopAnimated:NO];
        }
